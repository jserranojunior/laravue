...
<div>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.1.2/js/tempusdominus-bootstrap-4.min.css">
        <!-- iCheck -->
        <!-- <link rel="stylesheet" type="text/css"  href="/plugins/icheck-bootstrap/icheck-bootstrap.min.css"> -->
        <!-- JQVMap -->
        <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jqvmap/1.5.1/jquery.vmap.min.css">
        <!-- Theme style -->

        <link rel="stylesheet" type="text/css" href="https://cdn.jsdelivr.net/npm/admin-lte@3.0.0/dist/css/adminlte.min.css">
        <!-- <link rel="stylesheet" type="text/css"  href="/plugins_admin_lte/css/adminlte.min.css"> -->
        <!-- overlayScrollbars -->
        <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/overlayscrollbars/1.9.1/css/OverlayScrollbars.css">
        <!-- Daterange picker -->
        ...
        <!-- summernote -->
        <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.min.css">
        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="#" class="text-danger" v-if="auth.user.id" @click="logout()">Sair</a>
                    </li>
                </ul>
            </nav>
                ...
                <a href="./index3.html" class="nav-link">
                  ...
                  <p>Dashboard v3</p>
                    ...
                    <div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden">
                        <div class="os-scrollbar-track">
                            <div class="os-scrollbar-handle" style="height: 45.3581%; transform: translate(0px);"></div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content p-0">
                                            ...
                                            <div class="chart tab-pane active" id="revenue-chart" style="position: relative; height: 300px;">
                                                ...
                                                <canvas id="revenue-chart-canvas" height="300" style="height: 300px; display: block; width: 903px;" width="903" class="chartjs-render-monitor"></canvas>
                                            </div>
                            ...
                            <section class="col-lg-5 connectedSortable ui-sortable">
                                ...
                                <div class="card bg-gradient-primary">
                                    ...
                                    <div class="card-body">
                                        <div id="world-map" style="height: 250px; width: 100%; position: relative; overflow: hidden; background-color: transparent;"><svg width="629.167" height="250">
                                                <g transform="scale(0.42158516020236086) translate(266.6920620000001, 0)">
                                ...
                                <div class="card bg-gradient-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <canvas class="chart chartjs-render-monitor" id="line-chart" style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 629px;" width="629" height="250"></canvas>
                                    </div>
                                    <!-- /.card-body -->
                                    <div class="card-footer bg-transparent">
                                        <div class="row">
                                                                ...
                                                                <table class="table table-sm">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td data-action="selectDay" data-day="11/05/2019" class="day">5</td>
                                                                            <td data-action="selectDay" data-day="11/06/2019" class="day">6</td>
                                                                            <td data-action="selectDay" data-day="11/07/2019" class="day active today">7</td>
                                                                        ...
                                                                        <tr>
                                                                            <td data-action="selectDay" data-day="11/10/2019" class="day weekend">10</td>
                                                                            <td data-action="selectDay" data-day="11/11/2019" class="day">11</td>
                                                                            <td data-action="selectDay" data-day="11/12/2019" class="day">12</td>
                                                                            <td data-action="selectDay" data-day="11/13/2019" class="day">13</td>
                                                                            <td data-action="selectDay" data-day="11/14/2019" class="day">14</td>
                                                                            <td data-action="selectDay" data-day="11/15/2019" class="day">15</td>
                                                                            <td data-action="selectDay" data-day="11/16/2019" class="day weekend">16</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td data-action="selectDay" data-day="11/17/2019" class="day weekend">17</td>
                                                                            <td data-action="selectDay" data-day="11/18/2019" class="day">18</td>
                                                                            <td data-action="selectDay" data-day="11/19/2019" class="day">19</td>
                                                                            <td data-action="selectDay" data-day="11/20/2019" class="day">20</td>
                                                                            <td data-action="selectDay" data-day="11/21/2019" class="day">21</td>
                                                                            <td data-action="selectDay" data-day="11/22/2019" class="day">22</td>
                                                                            <td data-action="selectDay" data-day="11/23/2019" class="day weekend">23</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td data-action="selectDay" data-day="11/24/2019" class="day weekend">24</td>
                                                                            <td data-action="selectDay" data-day="11/25/2019" class="day">25</td>
                                                                            <td data-action="selectDay" data-day="11/26/2019" class="day">26</td>
                                                                            <td data-action="selectDay" data-day="11/27/2019" class="day">27</td>
                                                                            <td data-action="selectDay" data-day="11/28/2019" class="day">28</td>
                                                                            <td data-action="selectDay" data-day="11/29/2019" class="day">29</td>
                                                                            <td data-action="selectDay" data-day="11/30/2019" class="day weekend">30</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td data-action="selectDay" data-day="12/01/2019" class="day new weekend">1</td>
                                                                            <td data-action="selectDay" data-day="12/02/2019" class="day new">2</td>
                                                                            <td data-action="selectDay" data-day="12/03/2019" class="day new">3</td>
                                                                            <td data-action="selectDay" data-day="12/04/2019" class="day new">4</td>
                                                                            <td data-action="selectDay" data-day="12/05/2019" class="day new">5</td>
                                                                            <td data-action="selectDay" data-day="12/06/2019" class="day new">6</td>
                                                                            <td data-action="selectDay" data-day="12/07/2019" class="day new weekend">7</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </div>
...
export default {
    ...
    mounted() {
        ...
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.4.1/jquery.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/jquery-sparklines/2.1.2/jquery.sparkline.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/jQuery-Knob/1.2.13/jquery.knob.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.24.0/moment.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/daterangepicker.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.1.2/js/tempusdominus-bootstrap-4.min.js')
        VueScript2.load('https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote.min.js')
        VueScript2.load('https://cdn.jsdelivr.net/npm/overlayscrollbars@1.10.0/js/OverlayScrollbars.min.js')
        VueScript2.load('https://cdn.jsdelivr.net/npm/admin-lte@3.0.0/dist/js/adminlte.min.js')
